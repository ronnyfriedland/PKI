...
/**
 * Valdiator to verify if the extended key usage matches the requirements.
 * 
...
public class ExtendedKeyUsageValidator implements Validator {
     ...
     * 
     * @param allowedExtendedKeyUsages list of allowed extended key usages
     */
    public ExtendedKeyUsageValidator(final String... allowedExtendedKeyUsages) {
