...
public class DateRangeValidatorTest {
    ...
    private X509Certificate generateTestCertificate(final Date startDate, final Date expiryDate)
            throws NoSuchAlgorithmException, CertificateEncodingException, NoSuchProviderException, SignatureException,
            InvalidKeyException {
